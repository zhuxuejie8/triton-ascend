...
//   inproc-costmodel -ascend-perf-model="arg-bindings=arg2=100,pid_x=0" input.mlir
//   inproc-costmodel -ascend-perf-model="loop-trip-counts=4,6588" input.mlir
//   inproc-costmodel -ascend-perf-model="hardware-config=path/to/config.json" input.mlir
//   inproc-costmodel -ascend-perf-model="hardware-config=config.json arg-bindings=pid_x=0" input.mlir
//
//===----------------------------------------------------------------------===//
