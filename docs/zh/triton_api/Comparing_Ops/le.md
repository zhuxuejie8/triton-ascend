...
<<<<<<< HEAD
结论：Triton-Ascend 对比 GPU 暂不支持 uint8/uint16/uint32/uint64、fp64。
=======
结论：Triton-Ascend 对比 GPU 暂不支持uint, fp64,  fp8。
>>>>>>> release-3.2.2-0625-b79d137
...
=======
Triton-Ascend 对比 GPU 缺失fp64的支持能力, uint, fp8类型支持中。
>>>>>>> release-3.2.2-0625-b79d137

### 2.4 使用方法

以下示例实现了对三维张量`x0`、`x1`做小于等于运算：
